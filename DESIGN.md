...
- **Notiz-Textarea:** g1-Fläche, 1px g4-Rand, 15.5px Archivo; Fokus-Rand g6;
  Placeholder g6. Kein Session-Rating und kein Session-Feel mehr (Martin,
  31.08.2026: abgeschafft) — Fokus-Tage tragen das Verdict je Übung, an
  jedem Tagestyp ist die Notiz der einzige freiwillige Rückkanal.
...
- **Ein Navigationsmodell** (Paket 3 Strang 1): jeder Trainingstag wechselt
  ...
  Box-/Rad-Tage in eine WOD-Seite mit der Notiz am Ende. Ruhetage reagieren
  nicht. Das Inline-Akkordeon der Wochenliste (Chevron, `strip-body`) ist
  entfallen.
