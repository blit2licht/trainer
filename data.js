...
const DATA = {
  weeks: [
    {
      id: "2026-W25",
      label: "Woche 1 · 16.–22. Juni 2026",
      meso: "Meso 2 · Woche 1",
      phase: "Reclaim / Kapazität / Robustheit",
      dateFrom: "2026-06-16",
      dateTo:   "2026-06-22",
      days: [
        { day:"Montag",    date:"16.06.", isoDate:"2026-06-16", type:"rest", einheit:"—", rx:"—", note:"Erholung nach Wien. Kein Training — Di sauber starten." },
        { day:"Dienstag",  date:"17.06.", isoDate:"2026-06-17", type:"box",  einheit:"EMOM 32", sub:"Machine · HSPU · Hang C&J · Box Jumps · T2B", rx:"<span class='rv'>L2</span> — 42,5 kg Hang C&J · HSPU + T2B as written", rpe:"RPE ~7", note:"Engine-Wiedereinstieg. Kein L3/BMU — BMU-Budget für Do schonen." },
        { day:"Mittwoch",  date:"18.06.", isoDate:"2026-06-18", type:"box",  einheit:"Oly: Squat Clean + C&J Komplex", sub:"→ Gwen 15-12-9 C&J", rx:"Gwen <span class='rv'>L2 · 52,5 kg</span> (L3 60 kg wenn smooth)", rpe:"RPE 8 cap", note:"Heavy-Barbell-Tag. C&J-Volumen deckt Mi ab — nicht doppeln." },
        { day:"Donnerstag",date:"19.06.", isoDate:"2026-06-19", type:"own",  focus:"B", einheit:"Vertikal-Gymnastics", sub:"BMU-Reclaim · Strict HSPU · Pull/T2B · Mobility", rx:"Auf Anfrage", rpe:"RPE 7–8", note:"Box-Class Do gestrichen. Metabolisch ruhig." },
        { day:"Freitag",   date:"20.06.", isoDate:"2026-06-20", type:"rest", einheit:"Mobility / optionaler Z1–Z2-Spin", rx:"—", note:"Hero gestrichen. Puffer vor Sa-Focus und So-Ride." },
        { day:"Samstag",   date:"21.06.", isoDate:"2026-06-21", type:"own",  focus:"A", einheit:"Snatch-Reclaim + OHS-Stabilität", sub:"Pause OHS · Squat Snatch Komplex · Strict HSPU · GHD", rx:"Ceiling <span class='rv'>52 kg</span> W1", rpe:"RPE 8 cap", note:"Sa-Class gestrichen. Frisch durch Fr-Recovery." },
        { day:"Sonntag",   date:"22.06.", isoDate:"2026-06-22", type:"ride", einheit:"~75 km Z2/Z3", rx:"<span class='rv'>Fix</span> — nie streichen", note:"Bei schweren Sa-Beinen Intensität anpassen, nicht die Session."
      ...
      focusDays: {
        B: {
          title:"🏋️ Focus-Tag B", date:"Donnerstag · 19.06.2026",
        ...
        A: {
          title:"🏋️ Focus-Tag A", date:"Samstag · 21.06.2026",
